...
// if goal = 9, bigCount = 2, and smallCount = 0,
// the method should return false since each big
// bag is 5 kilos and cannot be divided. However,
// if goal = 9, bigCount = 1, and smallCount = 5,
// the method should return true because of 1 full
// bigCount bag and 4 full smallCount bags equal goal,

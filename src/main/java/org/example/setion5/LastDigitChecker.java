...
public class LastDigitChecker {
    ...
    public static boolean hasSameLastDigit(int a, int b, int c) {
        if (isValid(a) && (isValid(b)) && isValid(c)) {
            ...
            int rightMostDigitOfA = a % 10;
            int rightMostDigitOfB = b % 10;
            int rightMostDigitOfC = c % 10;

            return ((rightMostDigitOfA == rightMostDigitOfB) || (rightMostDigitOfA == rightMostDigitOfC)) || (rightMostDigitOfB == rightMostDigitOfC);
        }
        return false;
    }
